...
<%-- 
	상단 공통페이지 영역을 외부 포함파일로 처리하는 jsp:include 액션태그 
	서브페이지에서 외부포함파일로 처리하면 중복코드를 안하게 해줘서 효율성이 좋아진다.
	이렇게 처리하는 부분은 서버언어만 가능하다
--%>
...
<article id="sub_main_cont">
    ...
    <%-- figure는 html5에서 추가된 태드로 그림삽입해서 표현할 때 사용한다. figcaption도 html5에서 추가된 태그로 그림에 대한 부연설명을 설정할 때 사용한다. --%>
