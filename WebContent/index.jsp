<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- %@를 지시자 또는 디렉티브라고 한다. %@ page를 page 지시자 또는 page 디렉트브라고 한다 --%>
<%-- 어떤 페이지에 대한 정의문을 내린다 contentType="text/html; charset=UTF-8" 속성값의 의미는
 웹브라우저에 출력되는 태그/문자, 언어코딩 타입을 UTF-8로 설정하라는 의미  --%>
...
<body>
	...
	<div id="wrap">
		...
		<%-- 메인 이미지 --%>
		<div id="main_img">
			<img src="./images/main_img.jpg" width="971" height="282" alt="메인 이미지">
		</div>
		
		<%-- 메인 본문 --%>
		<article id="main_cont">	<%-- article 태그는 html5에서 추가된 것으로 본문 내용을 구성할 때 주로 사용 --%>
			<div id="solution">
				<div id="hosting">
			...
			<div id="news_notice">
				<h3 class="brown">News &amp; Notice</h3>	<%-- &amp;는 특수문자로 & 표시 --%>
				<table>
					<tr>
